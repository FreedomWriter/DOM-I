...
let appendNavChild = document.createTextNode("Append");
...
let ctaText = (document.querySelector(".cta-text h1").textContent =
  siteContent.cta.h1);
let breaks = "DOM\nIs\nAwesome!";
